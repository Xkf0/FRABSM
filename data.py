...
from dataset.seven_validation_dataset import SevenValidationDataset
...
class DataModule(pl.LightningDataModule):
    ...
    def prepare_data(self):
        ...
        if not os.path.isfile(self.concat_mem_file_name):
            ...
            concat = []
            for key in ['agedb_30', 'cfp_fp', 'lfw', 'cplfw', 'calfw', 'cfp_ff', 'vgg2_fp']:
    ...
    def subset_ms1mv2_dataset(self, subset_index):
        ...
        to_erase_label = value_counts[value_counts<7].index
...
def val_dataset(data_root, val_data_path, concat_mem_file_name):
    ...
    age_30, cfp_fp, lfw, age_30_issame, cfp_fp_issame, lfw_issame, cplfw, cplfw_issame, calfw, calfw_issame, cfp_ff, cfp_ff_issame, vgg2_fp, vgg2_fp_issame = val_data
    val_data_dict = {
        ...
        "vgg2_fp": (vgg2_fp, vgg2_fp_issame),
    }
    val_dataset = SevenValidationDataset(val_data_dict, concat_mem_file_name)
